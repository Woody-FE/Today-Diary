    ...
    <div class="diary-wrap">
      <div class="diary-header">
        ...
        <ul class="diary-header__func">
          <li>
            <img src="@/assets/images/text.svg" alt="편집" @click="openThemeModal" />
          </li>
          <li>
            <img src="@/assets/images/sticker.svg" alt="스티커" @click="openStickerModal" />
          </li>
          <li>
            <img src="@/assets/images/bgm.svg" alt="음악추가" @click="openMusicModal" />
          </li>
        </ul>
      </div>
      <ToastMusic :open="openMusic" @close-music="openMusic = false" @selectMusic="selectMusic" />
      <ToastSticker
        :open="openSticker"
        @submit-sticker="setSticker"
        @close-sticker="openSticker = false"
      />
      <ToastTheme :open="openTheme" @submit-theme="setTheme" @close-theme="openTheme = false" />
      <div class="diary-image">
        <img class="diary-image__value" v-if="diaryImageUrl" :src="diaryImageUrl" alt="일기사진" />
        <v-stage
          v-if="diaryImageUrl"
        ...
        <button id="deletePicture" @click="onDeletePicture">사진 지우기</button>
        <button id="deleteStickers" @click="onDeleteStickers">이모티콘 지우기</button>
        <label for="diary-image__input" v-if="diaryImageFile">
          <img src="@/assets/images/photos.svg" class="diary-image__file" alt="이미지추가하기" />
        </label>
        <input
          type="file"
      ...
      <button class="diary-complete-btn" @click="fetchAnalysis">오늘 감정 알아볼래요</button>
      <ToastSave :open="openSave" :diaryData="diaryData" @close-theme="openSave = false" />
      <Tutorial v-if="openTutorial" :open="openTutorial" @close-tutorial="openTutorial = false" />
    </div>
  </section>
</template>
